...
<div class="flex flex-col justify-end h-screen overflow-hidden">
    ...
    <div class="flex flex-1 overflow-hidden">
        ...
        <main class="flex-1 p-6 overflow-y-auto bg-white mt-14">
            ...
            <h2 class="flex justify-start pb-5 mx-auto text-lg font-semibold text-indigo-500">Accounts active in kaicourses<ion-icon class="pl-5 text-2xl text-gray-500" name="receipt"></ion-icon></h2>
                    ...
                    <c:forEach var="item" items="${accountsList}">
                            ...
                            <tr class="even:bg-blue-50">
                                <td class="px-2 py-2 text-sm">
                                    <img class="w-16 h-16 rounded-full" src="img/${item.getImageUrl()}" alt="">
                                </td>
