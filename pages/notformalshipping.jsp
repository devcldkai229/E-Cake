...
<script>
    function forwardToShoppingCart() {
        window.location.href = '/forwardcart';
    }
</script>
...
<div class="fixed inset-0 px-4 flex flex-wrap justify-center items-center w-full h-full z-[1000] before:fixed before:inset-0 before:w-full before:h-full before:bg-[rgba(0,0,0,0.5)] overflow-auto font-[sans-serif]">
    <div class="relative w-full max-w-lg px-6 py-5 mx-auto text-center bg-white rounded-lg shadow-lg">
        ...
        <div class="mt-6">
            ...
            <p class="mt-3 text-gray-600 text-lg font-bold ">Pls choose the formal delivery</p>

            <button onclick="forwardToShoppingCart()" type="button"
                    class="px-6 py-2.5 mt-8 w-full rounded-md text-white text-sm font-semibold tracking-wide border-none outline-none bg-red-500 hover:bg-red-600 cursor-pointer">Back to your cart</button>
        </div>
    </div>
</div>
</body>
