...
<head>
    ...
    <style>
        ...
        .custom-select {
            ...
            padding-right: 30px; /* Để không bị đè lên mũi tên */
        }
    ...
    <script src="js/adminorder2.js"></script>
</head>
...
<div class="flex flex-col justify-end h-screen overflow-hidden">
    ...
    <div class="flex flex-1 overflow-hidden">
        ...
        <main class="flex-1 p-6 overflow-y-auto bg-white">
            <div>
                <h1 class="text-3xl font-bold text-blue-600">REPORT STATISTICS</h1>
            </div>
            <!-- Table -->
            <form action="/orderReport" method="get" class="font-[sans-serif] flex justify-center space-x-10">
                <div class="mt-20 text-center">
                    <div class="relative max-w-sm">
                        ...
                        <input name="startDate" id="datepicker-actions0" datepicker datepicker-buttons datepicker-autoselect-today type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date">
                    </div>
                </div>
                <div class="mt-20 text-center">
                    <div class="relative max-w-sm">
                        ...
                        <input name="endDate" id="datepicker-actions1" datepicker datepicker-buttons datepicker-autoselect-today type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date">
                    </div>
                </div>
                <div class="mt-16">
                    <div class="relative mt-2">
                        <div class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[110%] h-[140%] overflow-hidden blur-[35px] opacity-60">
                            <div class="absolute flex items-center justify-center animate-spin [animation:spin_20s_linear_infinite]">
                                <div class="h-48 w-60 bg-gradient-to-tr from-pink-500 to-blue-600">
                                </div>
                            </div>
                        </div>
                        <button type="submit" class="relative flex items-center px-5 py-3 border rounded-2xl text-zinc-300 bg-zinc-900 border-1 border-zinc-500 group">
                            <div class="relative z-10 flex items-center font-semibold transition group-hover:text-white">
                                Create Report
                            </div>
                        </button>
                    </div>
            ...
            <div class="grid grid-cols-1 gap-6 py-10 sm:grid-cols-2 lg:grid-cols-3">
                <div class="p-6 transition-all transform bg-gray-100 rounded-lg shadow group hover:scale-105 bg-gradient-to-r hover:from-pink-400 hover:to-blue-400">
                    <h3 class="text-lg font-semibold text-gray-600 group-hover:text-gray-100">Total Products Ordered</h3>
                    <p class="flex justify-between mt-2 text-2xl font-bold text-gray-600 group-hover:text-gray-100">
                        ${totalProductsSales} <ion-icon class="text-3xl" name="pizza-sharp"></ion-icon>
                    </p>
                </div>

                <div class="p-6 transition-all transform bg-gray-100 rounded-lg shadow group hover:scale-105 bg-gradient-to-r hover:from-pink-400 hover:to-blue-400">
                    <h3 class="text-lg font-semibold group-hover:text-gray-100">Total Ordered</h3>
                    <p class="flex justify-between mt-2 text-2xl font-bold group-hover:text-gray-100">
                        ${totalOrders} <ion-icon class="text-3xl" name="cube-sharp"></ion-icon>
                    </p>
                </div>

                <div class="p-6 transition-all transform bg-gray-100 rounded-lg shadow group bg-gradient-to-r hover:from-pink-400 hover:to-blue-400 hover:scale-105">
                    <h3 class="text-lg font-semibold group-hover:text-gray-100">Income</h3>
                    <p class="flex justify-between mt-2 text-2xl font-bold group-hover:text-gray-100">
                        $${totalSales} <ion-icon class="text-3xl" name="wallet-sharp"></ion-icon>
                    </p>
                </div>
            ...
            <div>
                <h1 class="text-lg italic font-semibold text-blue-600">STATISTICS ORDERS DETAILS</h1>
                <hr class="border-t-2 border-collapse border-blue-400 w-[19%]">
            </div>

            <div class="overflow-x-auto font-[sans-serif] mt-12">
                <table class="min-w-full overflow-hidden bg-white">
                    ...
                    <c:forEach var="item" items="${orderReportList}">
                        <tr id="order-row-${item.getId()}" class="even:bg-blue-50">
                            ...
                            <td id="shippedDate-${item.getId()}" class="p-4 text-sm">
                                    ${item.getShippedDate()}
                            </td>
                            <td class="p-4 text-sm">
                                    ${item.getShipAddress()}
                            ...
                            <td class="p-4 text-sm">
                                <span id="status-${item.getId()}">${item.getStatus()}</span>
                            </td>
                            <td class="p-4 text-sm">
                                    ${item.getNote()}
                            </td>
