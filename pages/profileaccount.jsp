...
<head>
    ...
    <script src="js/profileaccount.js">
        ...
        <div class="max-w-screen-xl px-4 pb-6 mx-auto sm:px-6 lg:px-8 lg:pb-16">
            <div class="overflow-hidden bg-white rounded-lg shadow">
                <div class="divide-y divide-gray-200 lg:grid lg:grid-cols-12 lg:divide-y-0 lg:divide-x">
                        ...
                        <nav class="space-y-1">
                            ...
                            <a href="/profileaccount.jsp"
                               ...
                               x-state-description="undefined: &quot;bg-teal-50 border-teal-500 text-teal-700 hover:bg-teal-50 hover:text-teal-700&quot;, undefined: &quot;border-transparent text-gray-900 hover:bg-gray-50 hover:text-gray-900&quot;">
                                <ion-icon class="mr-2 text-3xl text-gray-700" name="cog-outline"></ion-icon>
                    ...
                    <form id="profileAccountForm" class="divide-y divide-gray-200 lg:col-span-9" onsubmit="updateEmailProcessing(event)">
                        <!-- Profile section -->
                        <div class="px-4 py-6 sm:p-6 lg:pb-8">
                            <div>
                                <h2 class="text-2xl font-medium leading-6 text-gray-900">Accounts</h2>
                                <p class="mt-1 text-sm text-gray-600">This information will be displayed publicly so be careful what
                                    you share.</p>
                                <p class="mt-1 text-sm font-semibold text-gray-800">Point Rewards: ${sessionScope.user.getPointRewards()}</p>
                            </div>
                            <div class="grid grid-cols-12 gap-6 mt-6">
                                <div class="col-span-12 sm:col-span-6">
                                    <label for="username" class="block text-sm font-medium text-gray-700">Username</label>
                                    <input readonly value="${sessionScope.user.getUsername()}" type="text" name="username" id="username" autocomplete="given-name" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:border-sky-500 focus:outline-none focus:ring-sky-500 sm:text-sm">
                                </div>

                                <div class="col-span-12 sm:col-span-6">
                                    <label for="password" class="block text-sm font-medium text-gray-700">Password</label>
                                    <input value="secretByUser" disabled type="password" name="password" id="password" autocomplete="family-name" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:border-sky-500 focus:outline-none focus:ring-sky-500 sm:text-sm">
                                </div>

                                <div class="col-span-12 sm:col-span-6">
                                    <label for="email" class="block text-sm font-medium text-gray-700">Email</label>
                                    <input value="${sessionScope.user.getEmail()}" type="text" name="newEmail" id="email" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:border-sky-500 focus:outline-none focus:ring-sky-500 sm:text-sm">
                                    <a onclick="sendInfoOTP()" id="getOtp" class="mt-2 text-blue-600 transition-colors cursor-pointer text-md hover:underline hover:text-blue-700">
                                        Get OTP
                                    </a>
                                    <span id="messageSent" class="mt-2 text-sm text-red-500"></span>
                                </div>

                                <div class="col-span-12 sm:col-span-6">
                                    <label for="code" class="block text-sm font-medium text-gray-700">OTP Code</label>
                                    <input placeholder="Enter your otp code from new email..." type="text" name="otpCode" id="code" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:border-sky-500 focus:outline-none focus:ring-sky-500 sm:text-sm">
                                </div>
                            </div>
                        </div>
