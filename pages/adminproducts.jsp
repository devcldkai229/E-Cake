...
<div class="flex flex-col justify-end h-screen overflow-hidden">
    ...
    <div class="flex flex-1 overflow-hidden">
        ...
        <main class="flex-1 p-6 overflow-y-auto bg-white">
            <!-- Cards -->
            <div class="grid grid-cols-1 gap-6 py-10 sm:grid-cols-2 lg:grid-cols-4">
                <div class="p-6 bg-gray-100 rounded-lg shadow">
                    <h3 class="text-lg font-semibold">Total Product</h3>
                    <p id="totalProduct" class="flex justify-between mt-2 text-2xl font-bold">${totalProducts} <ion-icon class="text-3xl" name="pizza"></ion-icon></p>
                </div>
            </div>
            <div class="flex items-center justify-around min-w-full mb-6">
                <h2 class="min-w-full mx-auto text-lg font-semibold text-indigo-500">Products currently in use</h2>
<%--                <div class="flex flex-col justify-center mr-10">--%>
<%--                    <div class="relative">--%>
<%--                        <div class="relative z-0 p-2 overflow-hidden rounded-full">--%>
<%--                            <form role="form" class="relative z-50 flex bg-white rounded-full">--%>
<%--                                <input type="text" placeholder="enter your search here" class="flex-1 px-6 py-4 text-gray-700 rounded-full focus:outline-none">--%>
<%--                                <button class="px-8 py-4 font-semibold text-white bg-indigo-500 rounded-full hover:bg-indigo-400 focus:bg-indigo-600 focus:outline-none">Search</button>--%>
<%--                            </form>--%>
<%--                            <div class="absolute z-10 bg-pink-400 glow glow-1"></div>--%>
<%--                            <div class="absolute z-20 bg-purple-400 glow glow-2"></div>--%>
<%--                            <div class="absolute z-30 bg-yellow-400 glow glow-3"></div>--%>
<%--                            <div class="absolute z-40 bg-blue-400 glow glow-4"></div>--%>
<%--                        </div>--%>
<%--                    </div>--%>
<%--                </div>--%>
            </div>
            ...
            <div class="overflow-x-auto font-[sans-serif]">
                <table class="min-w-full overflow-hidden bg-white">
                    ...
                    <tr>
                        <th class="py-4 text-sm font-medium text-left text-white">
                        ...
                        <th class="px-2 py-4 text-sm font-medium text-left text-white ">
                            Price
                        </th>
                        <th class="py-4 text-sm font-medium text-left text-white">
                            Actions
                    ...
                    <c:forEach var="item" items="${productsDashBoardDTOList}">
                        <tr class="even:bg-blue-50">
                            <td class="px-2 py-2 text-sm">
                                <img class="w-16 h-24 rounded-md" src="img/product/${item.getProductImgUrl()}" alt="">
                            </td>
                            ...
                            <td class="py-2">
                                <button class="mr-4" title="Edit">
                                    <ion-icon onclick="forwardToProductEdition(${item.getId()})" class="text-xl fill-blue-500 hover:fill-blue-700" name="create"></ion-icon>
                                </button>
                                <button class="mr-4" title="Delete">
                                    <ion-icon onclick="removeProduct(${item.getId()})" class="text-xl fill-blue-500 hover:fill-red-700" name="trash"></ion-icon>
                                </button>
                                <h3 id="messageRemoveError-${item.getId()}" class="text-red-500 hidden text-md"></h3>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
                <button onclick="forwardToProductCreation()" type="button" class=" mt-10 px-5 py-3 text-sm font-medium tracking-wider text-white transition-all duration-300 bg-green-600 border border-current rounded-lg outline-none hover:bg-transparent hover:text-green-700">New Products</button>
                <button type="button" class=" mt-10 px-5 py-3 text-sm font-medium tracking-wider text-white transition-all duration-300 bg-red-600 border border-current rounded-lg outline-none hover:bg-transparent hover:text-red-700">Delete</button>
            </div>
        </main>
    </div>
</div>
