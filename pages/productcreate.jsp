...
<script>
  function onChangeFileName() {
    ...
    const fileName = fileInput.files[0] ? fileInput.files[0].name : 'Chosen file';
...
<div class="max-w-4xl p-6 mx-auto mt-20 bg-white rounded-md shadow-xl shadow-blue-300 dark:bg-gray-800">
  <h1 class="text-xl font-bold text-gray-600 capitalize dark:text-white">Product creation</h1>
  <form onsubmit="createProductDashBoard()" id="productForm" enctype="multipart/form-data" method="post">
    <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
      <div>
        <label class="text-gray-600 dark:text-gray-200" for="nameProducts">Name</label>
        <input name="nameServlet" placeholder="Enter name..." id="nameProducts" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
      ...
      <div>
        ...
        <input name="quantityServlet" id="unitsOfStocks" type="number" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
      ...
      <div>
        ...
        <input name="priceServlet" id="price" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
      ...
      <div class="bg-white text-[#333] flex items-center shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] p-1 min-w-[300px] w-max font-[sans-serif] rounded-md overflow-hidden my-7 mx-auto">
        <div class="flex px-4">
          ...
          <p class="ml-3 text-sm" id="fileName">Choose file</p>
        </div>
