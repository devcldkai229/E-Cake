                    ...
                    <ul class="mt-3 space-y-2">
                        <li>
                            <a href="/adminorderlist"
                               class="flex items-center px-4 py-2 text-sm text-gray-800 transition-all bg-gray-100 rounded-md">
        ...
        <main class="flex-1 p-6 overflow-y-auto bg-white">
            ...
            <div class="grid grid-cols-1 gap-6 py-10 sm:grid-cols-2 lg:grid-cols-4">
                <div class="p-6 bg-gray-100 rounded-lg shadow">
                    ...
                    <p class="flex justify-between mt-2 text-2xl font-bold">${totalProducts} <ion-icon class="text-3xl" name="pizza-sharp"></ion-icon></p>
                </div>
                <div class="p-6 bg-gray-100 rounded-lg shadow">
                    <h3 class="text-lg font-semibold">Sales</h3>
                    <p class="flex justify-between mt-2 text-2xl font-bold">$${totalSales} <ion-icon class="text-3xl" name="wallet-sharp"></ion-icon></p>
                </div>
                <div class="p-6 bg-gray-100 rounded-lg shadow">
                    <h3 class="text-lg font-semibold">Orders</h3>
                    <p class="flex justify-between mt-2 text-2xl font-bold">${totalOrders} <ion-icon class="text-3xl" name="cube-sharp"></ion-icon></p>
                </div>
                <div class="p-6 bg-gray-100 rounded-lg shadow">
                    <h3 class="text-lg font-semibold">Undelivered</h3>
                    <p id="totalOrderUndelivered" class="flex justify-between mt-2 text-2xl font-bold">${totalOrdersUndelivered} <ion-icon class="text-3xl" name="clipboard-sharp"></ion-icon></p>
                </div>
            </div>

            <h2 class="flex justify-start pb-5 mx-auto text-lg font-semibold text-indigo-500">Orders currently <ion-icon class="pl-5 text-2xl text-gray-500" name="receipt"></ion-icon></h2>
            ...
            <div class="overflow-x-auto font-[sans-serif]">
                <table class="min-w-full overflow-hidden bg-white">
                    ...
                    <c:forEach var="item" items="${ordersDashBoardDTOList}">
                        <tr id="order-row-${item.getId()}" class="even:bg-blue-50">
                            ...
                            <td class="flex items-center text-left">
                                ...
                                <div class="relative flex items-center py-3 ml-2 ">
                                    <select class="pr-10 appearance-none custom-select">
                                    ...
                                    <div class="absolute inset-y-0 flex items-center pointer-events-none right-3">
                                        <svg class="w-4 h-4 text-gray-500" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd" d="M5.22 7.22a.75.75 0 0 1 1.06 0L10 11.94l3.72-3.72a.75.75 0 1 1 1.06 1.06l-4.25 4.25a.75.75 0 0 1-1.06 0L5.22 8.28a.75.75 0 0 1 0-1.06Z" clip-rule="evenodd" />
                                        </svg>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="p-4">
                                <button class="mr-4" title="Edit">
                                    <ion-icon onclick="markCompleteOrder(${item.getId()})" class="text-xl fill-blue-500 hover:fill-blue-700" name="create"></ion-icon>
                                </button>
                                <button class="mr-4" title="Delete">
                                    <ion-icon onclick="removeOrder(${item.getId()})" class="text-xl fill-blue-500 hover:fill-red-700" name="trash"></ion-icon>
                                </button>
