        ...
        <main class="flex-1 p-6 overflow-y-auto bg-white">
            ...
            <div class="grid grid-cols-1 gap-6 py-10 sm:grid-cols-2 lg:grid-cols-4">
                <div class="p-6 bg-gray-100 rounded-lg shadow">
                    ...
                    <p id="totalCategories" class="flex justify-between mt-2 text-2xl font-bold">${totalCategories} <ion-icon class="text-3xl" name="pricetags-sharp"></ion-icon></ion-icon></p>
                </div>
            </div>

            <h2 class="flex justify-start pb-5 mx-auto text-lg font-semibold text-indigo-500">Categories currently are adapting with kaicourses<ion-icon class="pl-5 text-2xl text-gray-500" name="receipt"></ion-icon></h2>
            <!-- Table -->
            <div class="overflow-x-auto font-[sans-serif]">
                <table class="min-w-full overflow-hidden bg-white">
                    ...
                    <c:forEach var="item" items="${categoriesList}">
                        <tr id="category-row-${item.getId()}" class="even:bg-blue-50">
                            ...
                            <td class="p-4">
                                ...
                                <button  onclick="removeCategory(${item.getId()})" class="mr-4" title="Delete">
                ...
                <button onclick="forwardToCategoryCreation()" type="button" class=" mt-10 px-5 py-3 text-sm font-medium tracking-wider text-white transition-all duration-300 bg-green-700 border border-current rounded-lg outline-none hover:bg-transparent hover:text-green-700">New Categories</button>
            </div>
        </main>
    </div>
</div>
