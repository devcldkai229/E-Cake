...
@WebServlet("/ofcategories")
public class ProductOfCategoriesController extends HttpServlet {

    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        String categoryId = request.getParameter("categoryId");
        List<Products> productsList = ProductService.getInstance().productsOfCategory(Integer.parseInt(categoryId));
